...
export default function CreateOrder({auth, ...props}){
                ...
                <div className="space-y-5 flex flex-col">
                        ...
                        <div className="w-full p-5 space-y-5">
                            <form encType='multipart/form-data' className="grid grid-cols-2 gap-x-5 gap-y-5">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <select name='order_type' onChange={(e) => setData(e.target.name, e.target.value)} className="py-1 text-input">
                    ...
                    <div className="w-full h-fit bg-white shadow-md rounded-md overflow-hidden">
                        <div className="p-5 flex items-center justify-between border-b border-light-3">
                            ...
                            <button onClick={(e) => shoesModalHandler(e)} className="px-5 py-1 btn-submit">Tambah</button>
                        </div>
                                        ...
                                        <tbody>
                                            {
                                                ...
                                                <tr className="border-t border-light-3 bg-white">
                                                        <td colSpan={6} className="py-2.5 px-1 text-center text-sm italic">Belum ada data sepatu yang ditambahkan.</td>
                                                    </tr> 
                                                :
                            ...
                            <div className="flex gap-5">
                                ...
                                <div className="w-1/3 ms-auto divide-y flex flex-col divide-light-3">
                                    ...
                                    <div className="p-2 space-y-2">
                                        <button onClick={(e) => submit(e)} className="w-full px-5 py-1 btn-submit">Buat Pesanan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <Modal show={shoesModal} onClose={() => setShoesModal(false)} maxWidth='xl'  >
                <form className='p-7 space-y-7 flex flex-col'>
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        <div className="px-2 py-2 flex items-center justify-between bg-light-1 border border-light-1 font-medium" >
                            <span>Harga</span>
                    ...
                    <div className="flex items-center justify-end space-x-3">
                        <button onClick={(e) => shoesModalHandler(e)} className="px-5 py-1.5 rounded-md btn-danger">Batal</button>
                        <button onClick={(e) => addShoes(e)} className="px-5 py-1.5 rounded-md btn-submit">Simpan</button>
                    </div>
                </form>
            </Modal>
        </>
