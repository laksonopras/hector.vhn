...
export default function Payment({auth, ...props}){
    ...
    return(
        <AdminLayout user={auth.user} >
            <h1 className="p-5 text-xl border-b border-light-3">Pembayaran</h1>
            <div className="p-5 space-y-5">
                ...
                <div className="w-full rounded-md border border-light-3 overflow-x-auto">
                    <table className="w-full">
                        <thead>
                            ...
                            <th className="py-3 px-2">Nominal Tagihan</th>
                            ...
                            : orders.map((order, index) => {
                                return(
                                    <tr key={index} className={'text-black ' + ( index  % 2 == 0 ? 'bg-light-1 ' : 'bg-white ')}>
                                        ...
                                        <td className='py-3 px-1 text-center'>Rp. {order.price}</td>
                ...
                <div className="flex items-center justify-between space-x-1">
                    <p>Show {((currentPage - 1) * rows) + 1} to {((currentPage - 1) * rows) + orders.length} of {props.orders.length} entries</p>
