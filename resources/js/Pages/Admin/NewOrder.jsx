...
export default function NewOrder({auth, ...props}){
    ...
    const updateStatus = (e, id, order_id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.visit('/pesanan/status', { method : 'post', data : {id: id, status: 2}})
            }
        });
    }
    ...
    return(
        <AdminLayout user={auth.user} >
            <h1 className="p-5 text-xl border-b border-light-3">Pesanan Baru</h1>
